...
public class CreateNewsRepository {
	...
	/*public static void uploadFile(WebDriver driver) throws InterruptedException {
		...
		//validating News
		public static void validate(WebDriver driver, int titlenumber) {
			String actual ="Selenium Automation Service News #" + titlenumber;
			element=driver.findElement(By.xpath(".//*[contains(text(), 'Service News #"+titlenumber+ "')]"));
